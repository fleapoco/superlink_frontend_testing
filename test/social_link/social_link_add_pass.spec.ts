...
describe("image upload ", () => {
  ...
  test("testing start", async () => {
    ...
    await page
      .locator(
        '//*[@id="__next"]/div[2]/div[3]/div[1]/div[1]/div[2]/div/div[1]'
      )
      .click();
    await page
      .locator(
        '//*[@id="__next"]/div[2]/div[3]/div[1]/div[1]/div[2]/div/div[2]/ul/div/button'
      )
      .click();
    await page.selectOption('//*[@id="platform"]', {
      label: "Facebook",
    });
    const linkInput = await page.locator(
      '//*[@id="__next"]/div[2]/div[4]/div/div[2]/div/div/form/div[2]/input'
    );
    await linkInput.type("https://www.facebook.com/santra2021");
    await page.waitForTimeout(2000);
    await page
      .locator('//*[@id="__next"]/div[2]/div[4]/div/div[2]/div/div/form/button')
      .click();
  });
  // await page.waitForTimeout(10000);
  // await browser.close();
